const { catchAsyncDB } = require("./functions.js");
const mongoose = require("mongoose");

exports.aggregateAll = catchAsyncDB(
  async (resolve, reject, model, filter, query) => {
...
exports.aggregateOne = catchAsyncDB(async (resolve, reject, model, query) => {
  let module = await import(`../models/${model}.model.mjs`);
  let Model = module.default;
  const aggregate = await Model.aggregate(query);
